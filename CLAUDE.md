...
- **Что было в прошлых сессиях** — выжимки в `projects/pc-keeper/sessions/`: их сохраняют хуки при сжатии и сбросе контекста. Перед новой задачей посмотри выжимки по теме — номер задачи, `topic` и `keywords` во frontmatter.
